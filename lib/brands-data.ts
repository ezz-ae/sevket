...
export const brands: Brand[] = [
  ...
  },
  {
    ...
    slug: "affarem",
    name: "AFFAREM",
    tagline: "Smart Operations Technology",
    description:
      "Control layer technology platform providing real-time visibility, CCTV monitoring, remote management, and operational analytics for all franchise units.",
    founded: "2022",
    ...
    keyMetrics: [
      ...
      { label: "System Capability", value: "100% Remote" },
    ],
    operationalFocus: [
